...
\usepackage{amsthm}
% \theoremstyle{remark}
\newtheoremstyle{hypothesis}% <name>
	{3pt}% <Space above>
	{3pt}% <Space below>
...
% Footnote formating - use \note to have double-spaced footnotes
...
%\setcounter{secnumdepth}{0} % Uncomment to suppress section numbering

% Table and Figure Heading Format
\usepackage{floatrow}
...
\addbibresource{dissbib20200511}
\AtEveryBibitem{%
	\clearfield{note}%
	\clearlist{language}%
}
